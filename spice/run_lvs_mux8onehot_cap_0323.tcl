...
set layout [readnet spice mux8onehot_cap_0323_mag.spice]
...
readnet spice mux8onehot_cap_0323.spice $source

# 5. LVSの実行
puts "Running LVS..."
lvs [list $layout mux8onehot_cap_0323] \
    [list $source mux8onehot_cap_0323] \
    /home/isshu/pdk/sky130A/libs.tech/netgen/sky130A_setup.tcl \
    mux8onehot_cap_0323_comp.out